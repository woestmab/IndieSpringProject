...
<html>
  ...
  <body>
    <c:import url="/templates/header-nav-bar-secure.jsp"/>

    <c:import url="/templates/cal-div.jsp"/>
    <c:import url="/templates/route-div.jsp"/>
    <c:import url="/templates/edit-div.jsp"/>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="make-appt" method="post">
              <div id="locationForm">
                <c:import
                    url="/templates/location-form-fragment.jsp"/>
                <c:import
                    url="/templates/appointment-form-fragment.jsp"/>
              </div>
